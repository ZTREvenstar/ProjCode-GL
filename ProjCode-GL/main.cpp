...
void sendDataToOpenGL() {
    ...
    faces.push_back("Textures/skybox/right1.bmp");
    faces.push_back("Textures/skybox/left1.bmp");
    faces.push_back("Textures/skybox/top1.bmp");
    faces.push_back("Textures/skybox/bottom1.bmp");
    faces.push_back("Textures/skybox/back1.bmp");
    faces.push_back("Textures/skybox/front1.bmp");
